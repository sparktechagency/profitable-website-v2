  ...
  return (
    <div className="p-4 mt-16">
      <div className="flex justify-between px-4">
        ...
        <button className="border border-orange-600 px-7 py-2 text-orange-600">
          Move All To Bag
        </button>
      </div>
      {wishItems.length === 0 ? (
              ...
              <div key={item.id} className="m-4">
                <div className="relative">
                  <div className="bg-[#DFE1E3] rounded-sm flex items-center justify-center w-full h-[240px] group">
                    ...
                    <div
                      className="absolute top-3 right-3 bg-white p-1 rounded-full text-black text-xl cursor-pointer"
      ...
      <div>
        <div className="flex justify-between px-4">
          <div className="flex">
            <Title></Title>{" "}
            <span className="md:mt-16 mt-6 text-lg">Just For You</span>
          </div>
          <div>
            <Link href={"/allproduct"}>
              <button className="border md:mt-11 mt-4 border-orange-600 px-7 py-2 text-orange-600">
                See All
              </button>
            </Link>
          </div>
